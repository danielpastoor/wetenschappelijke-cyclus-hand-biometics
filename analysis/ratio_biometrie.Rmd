...
3. Je laborant-ID: een unieke _identifier_ die jou als onderzoeker identificeert. Neem hiervoor een nummer.
...
:::attention
De resultaten zijn in het volgende formaat opslagen.
Waarbij de kolomen de volgende betekenis hebben:

1. id_onderzoeker = id van de onderzoeker.
2. id_data = id voor de subject.
3. lengte = de lengte van de hand.
4. breedte = de breedte van de hand.
5. sexse = het geslacht van de subject die kan of man of vrouw zijn.

Voorbeeld:
<pre>
id_onderzoeker;id_data;lengte;breedte;sexse
...
#### Boxplot
Dit is een boxplot van alle verkegen data. Onder verdeeld tussen lengte en breedte
